module ActiveScaffold::Actions
  module Delete
    ...
    def do_destroy
      ...
      # Patch by Erik: pass on any errors from the model to the controller/view flash
      # this could e.g. be a message that a record can't be deleted because of referential integrity
      flash[:error] = @record.errors.on_base
    end
